...
class BiSeNet(nn.Module):
    ...
    def forward(self, x):
        H, W = x.size()[2:]
        #feat2, feat4, feat8, feat16, feat16_up, feat32_up
        ...
        feat_out = F.interpolate(feat_out, (H, W), mode='bilinear', align_corners=True)#最终特征图
        feat_out16 = F.interpolate(feat_out16, (H, W), mode='bilinear', align_corners=True)#辅助loss
